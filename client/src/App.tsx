...
type AppConfig = { callbackUrl: string; statementCallbackUrl: string; acbConfigured: boolean; postgresSsl: boolean; environment: string };
type Ops = {
